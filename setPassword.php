    ...
    <header>
        <div class="fixed-top">
            <nav class="navbar navbar-expand-lg navbar-light navbar-fixed-top">
                <a class="navbar-brand" href="index.php"> <img src="images/post-it.png" class="img-fluid rounded mx-auto"
                        width="30" height="30" alt="Sticky Note Icon">Petek</a>
            ...
            <form class="align-middle" id="passwordRegFrm" novalidate>
                <div class="form-group col-md-12">
                    <div class="form-row ">
                        ...
                        <input type="password" class="form-control" id="pwdReg" name="pwdReg" placeholder="Password"
                            required>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <input type="password" class="form-control" id="conpwdReg" name="conpwdReg"

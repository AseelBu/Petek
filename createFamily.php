      ...
      <form class="align-middle " id="newUserFrm" method="POST" action="api/newInvite.php" >
        <div class="form-group col-md-12">
          <div class="form-row ">
            ...
            <label for="invitedInfo" class="">Enter your family Name: </label>
            <input type="invitedInfo" class="form-control" id="familyName" name="familyName" title="Enter family Name" placeholder="Family name" required>
